...
const HowItWorks: React.FC = () => {
  ...
  const steps = [
    {
      ...
      description:
        "Sign up and use our intuitive builder to create your event. Add details, set pricing, and customize your page.",
      visual: (
    ...
    },
    {
      ...
      description:
        "Share your event link on social media. Customers buy tickets and pay instantly via their preferred method.",
      visual: (
        <div className="visual-box">
  ...
  return (
    <section id="how-it-works" className="how-it-works">
      <SectionHeader title="Get Started in 3 Simple Steps" subtitle="Launch your first event in under 5 minutes" />
